            ...
            <div className='row'>
                <div className='events-calendar'>
                    ...
                    <div className='col-md-6'>
                        ...
                        {this.props.acceptedOffer ? <span className='color-text-black'>Confirmed </span> :
                            <span className='color-text-black'>Not confirmed </span>}    |
                <span className='color-text-black'> Participants: </span>{this.props.participants.length}
                        <p><span className='color-text-black'>Theme: </span>{this.props.theme.map(theme => <span className='btn btn-grey'>{theme}</span>)}</p>
                    </div>
